...
/**
 * Placeholder della schermata Scadenzario.
 *
...
fun ExpiryScreen(
    ...
    Scaffold(
        ...
        MediShelfPlaceholderScreen(
            title = stringResource(R.string.expiry_placeholder_title),
            body = stringResource(R.string.expiry_placeholder_body),
...
/**
 * Preview dello Scadenzario placeholder.
 */
@Preview(showBackground = true)
@Composable
private fun ExpiryScreenPreview() {
    MediShelfTheme {
        ExpiryScreen(onMedicineClick = {})
    }
}
